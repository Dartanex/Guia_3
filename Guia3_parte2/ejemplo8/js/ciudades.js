function inicar(){
    ...
    cities["Italia"] = ["Roma", "Turín", "Mil´pan", "Venecia", "Verona"];
    ...
    //Asociando al manejador de evento click al elemento select country
    ...
    //Asociando el manejo del evento click
...
//Esta funcion limpia todas las opciones del menú desplegable de las ciudades
function removeOptions(optionMenu){
    for(i=0;i<optionMenu.option.length;i++){
        optionMenu.option[i] = null;
    }
}

/*Esta funcion agrega nuevas opciones en el menú desplegable de las ciudades, dependiendo del país seleccionado.
Las ciudades para llenar el campo son tomadas del array asociativo correspondiente */
