//Declaración de variables e inicialización, si es conveniente
var propiedad, str = "";
var cantidad = 0;
str += "<header id=\"three-d\">";
str += "<h1>Propidedades del objeto navigator</h1>";
str += "</header>";
str += "<section>";
str += "<article>";
str += "<table class=\"tab-x\" sumary=\"Propiedades del navegador\"";
str += "<thead>";
