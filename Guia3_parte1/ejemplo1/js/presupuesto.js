function init() {
    ...
    var presupuesto = prompt('Ingrese presupuesto anual', '');
    var derma, trauma, pedia, i;
    var div = document.getElementById('distribucion');

    //Realizando los cálculos para distribución de presupuesto
    ...
    html += "\t<li>\n";
    html += "\t\t<a href='#' class='move-right'>\n";
    html += "\t\t\tEl presupuesto asignado para Traumatología es: $ " + pedia + "\n";
    html += "\t\t</a>\n";
    html += "\t</li>\n";

    html += "</ul>\n";

    //Hacer referencia a los elementos div del código asignado en la variable html
    div.innerHTML = html;
